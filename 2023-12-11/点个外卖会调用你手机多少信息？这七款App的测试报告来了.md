...
![](https://inews.gtimg.com/om_bt/OrNJhREXj-xnIB_RmF_wLPTALvAkqsjFcAIA7srFPfC_MAA/1000)
_表1 7款App基本情况_
...
![](https://inews.gtimg.com/om_bt/OghWhzpGnZIjwE6pNq3PN1gacboQg5FUdTYX-VU0XQqxAAA/1000)
_表4 搜索商品场景调用系统权限情况_

（4）在选购商品场景中，调用系统权限种类最多的为美团、饿了么、叮咚买菜、口碑、京东到家（均为1类），调用系统权限次数最多的为美团、叮咚买菜、口碑、京东到家（均为2次）。具体情况如表5。

![](https://inews.gtimg.com/om_bt/OnkE9S2R_d-bql9mhYsUEF2h_OYlIfFA3ye8MqVWb8LToAA/1000)
_表5 选购商品场景调用系统权限情况_
...
![](https://inews.gtimg.com/om_bt/OykqV2jJtN--FCvD3z3opfYyN4UyBNm3OfRdXMcYjqC9cAA/1000)
